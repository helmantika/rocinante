...
$fp = $l10n->frontpage;
?>
   <!-- This is the HTML code for the dialog that is shown when 'New user' button is clicked. -->
   <div id="new-user-dialog" title="<?php echo $fp->{"tabs"}->{"admin"}->{"tabs"}->{"users"}->{"new-user-button"} ?>">

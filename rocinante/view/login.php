...
<html>
   ...
   <body class="hide" style="background-color: <?php echo $helper->getBackground() ?>">
      <div id="main">
         ...
         <div class="ui-widget ui-corner-all" id="login">
            <form id="login-form"> 
               <p><input type="text" name="username" placeholder="<?php echo $l10n->loginpage->username ?>" value=""/></p>
               <p><input type="password" name="password" placeholder="<?php echo $l10n->loginpage->password ?>" /></p>
            </form>
         </div>
         <div class="ui-state-error ui-corner-all" id="wrong-data">
            <p><?php echo $l10n->loginpage->error ?></p>
         </div>

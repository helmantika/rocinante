...
?>
   ...
   <div id="new-message-from-draft-dialog" title="<?php echo $fp->{"tabs"}->{"mail"}->{"new-message-button"} ?>">
            ...
            <fieldset>
               ...
               <tbody> 
                  <tr> 
                     ...
                     <td style="width: 10%"><button class="ui-state-default" id="search-user-table-3"><?php echo $l10n->{"dialog"}->{"mail"}->{"select"} ?></button></td>
                  </tr>    
                  <tr> 
